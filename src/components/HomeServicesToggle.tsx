...
// Contextual details to inject utility into the expanded state without a pricing list
...
export function HomeServicesToggle() {
  ...
  const handleScrollToMap = (e: React.MouseEvent) => {
    e.stopPropagation(); // Avoid triggering card toggle closures
            ...
            {categories.map((c) => {
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    setActive(c.id);
                    setExpandedService(null); // Clear expansion state on category swap
                  }}
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2">
          <AnimatePresence mode="popLayout">
            {items.map((service, i) => {
              ...
              // Custom contextual WhatsApp link for this exact service
              ...
              return (
                ...
                >
                  {/* Top Half: Horizontal Standard Block */}
                  <div className="flex h-40 w-full flex-row">
                    {/* Immovable Media Frame */}
                      ...
                      >
                        ...
                        <div className="mt-6 flex flex-wrap gap-2.5">
                          <a
                            ...
                            onClick={(e) => e.stopPropagation()} // Stop bubbling up to close card
...
export const salon = {
  ...
  city: "Middlesbrough",
  postcode: "TS1",
  phoneIntl: "447000000000", // Swap with actual international format number
